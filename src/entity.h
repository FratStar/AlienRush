...
typedef struct ENTITY_T
{
  ...
  arUI32 NextThink;         /*used for how often the entity thinks*/
  arUI16 ThinkRate;         /*used for incrementing above*/
  arUI32 NextUpdate;        /*used for how often the entity is updated, updating is merely animations*/
  arUI16 UpdateRate;        /*used for incrementing above*/
  ...
  arRect  Boundingbox;    /*the bounding box for collision detection*/
  arRect  ClipBox;        /*the bounding box for hit detection*/
 /* Coord Ls;                 /*offset coordinates to draw the legs at*/
  ...
  int jump;					/*controls the player's jumping so it isn't infinite*/
  int jumpcd;
}Entity;
